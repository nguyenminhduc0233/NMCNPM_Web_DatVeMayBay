...
<head>
    ...
    <!--title tag for page -->
    <title>FlightWorld - Traveller Addons - Baggage Details</title>
</head>
                        ...
                        <div class="col-8">
                            <ul class="d-flex nav nav-pills addons-tab" id="pills-tab" role="tablist">
                                <li class="nav-item mb-3 mb-sm-0" role="presentation">
                                    <a class="p-2 border theme-border-radius d-flex align-items-center" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">
                                ...
                                <li class="nav-item ms-0 ms-sm-3" role="presentation">
                                    <a class="p-2 border theme-border-radius d-flex align-items-center" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">
                                        <div class="flex-shrink-0">
                                            <img src="assets/images/icons/6E.jpg" class="img-fluid" alt="Indigo" title="airline Indigo">
                                        </div>
                                        <div class="flex-grow-1 ms-2">
                                        ...
                                        <div class="row g-0 mb-3">
                                            ...
                                            <div class="col-12 col-md-8 offset-md-2 p-2">
                                                ...
                                                <ul class="d-md-flex justify-content-between pt-3">
                                                    <li class="pb-3">
                                                        <img src="assets/images/icons/baggage-small.png" class="img-fluid" alt="Bagg">
                                                ...
                                                <ul class="d-md-flex justify-content-between pt-3">
                                                    <li class="pb-3">
                                                        <img src="assets/images/icons/baggage-small.png" class="img-fluid" alt="Bag">
