                        ...
                        <div class="col-12 col-md-9">
                            ...
                            <div class="theme-box-shadow theme-border-radius bg-light mb-3">
                                <div class="row border-bottom py-2 m-auto">
                                    ...
                                    <div class="col-4 text-end align-self-center">
                                        <a class="font-small theme-text-accent-one" data-bs-toggle="collapse" href="#collapseDepart" role="button" aria-expanded="false" aria-controls="collapseDepart">Flight
                            ...
                            <div class="theme-box-shadow theme-border-radius bg-light mb-3">
                                <div class="row border-bottom py-2 m-auto">
                                    ...
                                    <div class="col-4 text-end align-self-center">
                                        <a class="font-small theme-text-accent-one" data-bs-toggle="collapse" href="#collapseReturn" role="button" aria-expanded="false" aria-controls="collapseReturn">Flight
                                            Details
                                            ...
                                            <div class="px-3">
                                                <ul class="row py-3">
                                                    ...
                                                    <li class="col-12 col-md-6 col-lg-3 pb-3">
                                                        ...
                                                        <div class="font-medium fw-bold">14:05 | <span class="fw-normal">Sat,
                                                                Mar 30</span></div>
                                                        <div class="font-small">Indira Gandhi, T - 1D</div>
                                                    </li>
                                                    <li class="col-12 col-md-6 col-lg-3 pb-3">
                                                    ...
                                                    <li class="col-12 col-md-6 col-lg-3 pb-3">
                                                        ...
                                                        <div class="font-medium fw-bold">15:30 | <span class="fw-normal">Sat,
                                                                Mar 30</span></div>
                                                        <div class="font-small">Cochin, T - 2</div>
                                                    </li>
                                                    <li class="col-12 col-md-6 col-lg-3 pb-3"> <span class="font-small text-uppercase fw-bold"> <i
                                                    ...
                                                    <li class="col-12 mb-3 text-center">
                                                        <div class="border d-inline-block theme-border-radius font-small p-2">
                                                            Change planes at Mumbai, Connecting Time: 2h 50m Connecting flight may depart from a different terminal</div>
                                                    </li>
                                                    <li class="col-12 pb-3">
                                                        <div class="float-start">
                                                            <img src="assets/images/icons/D-goair.jpg" alt="goair">
                                ...
                                <div class="col-12 border-bottom">
                                    ...
                                    <div class="theme-box-shadow theme-border-radius bg-light mb-3">
                                        <div class="row border-bottom py-2 m-auto">
                                            ...
                                            <div class="col-4 text-end align-self-center">
                                                <a class="font-small" data-bs-toggle="collapse" href="#collapseAdult" role="button" aria-expanded="false" aria-controls="collapseAdult"><i
                                                    ...
                                                    <div class="px-3">
                                                        <ul class="row py-3">
                                                            ...
                                                            <li class="col-12 col-md-4 pb-3">
                                                                <label class="visually-hidden" for="specificSizeInputFirstName">First Name</label>
                                                                <input type="text" class="form-control" id="specificSizeInputFirstName" placeholder="First Name">
                                                            </li>
                                                            <li class="col-12 col-md-4 pb-3">
                                                                <label class="visually-hidden" for="specificSizeInputLastName2">Last Name</label>
                                                                <input type="text" class="form-control" id="specificSizeInputLastName2" placeholder="Last Name">
                                                            </li>
                                                            <li class="col-12 col-md-6 pb-3">
                                                                ...
                                                                <div class="row g-0 border">
                                                                    <div class="col">
                                                                        <select class="form-select border-0" id="inlineFormSelectTitle3">
                                                                    ...
                                                                    <div class="col">
                                                                        <select class="form-select border-0" id="inlineFormSelectTitle4">
                                                                    ...
                                                                    <div class="col">
                                                                        <select class="form-select border-0" id="inlineFormSelectTitle15">
                                                            ...
                                                            <li class="col-12 col-md-12 pb-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                                                                        <label class="visually-hidden" for="specificSizeInputPassportNumber">Passport
                                                                            Number</label>
                                                                        <input type="text" class="form-control" id="specificSizeInputPassportNumber" placeholder="Passport Number">
                                                                    </div>
                                                                    <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                                                                        <label class="visually-hidden" for="inlineFormSelectNationality3">Nationality</label>
                                                                        <select class="form-select" id="inlineFormSelectNationality3">
                                                                    ...
                                                                    <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                                                                        <label class="visually-hidden" for="inlineFormSelectIssuedCountry">Issued
                                                                            Country</label>
                                                                        <select class="form-select" id="inlineFormSelectIssuedCountry">
                                                                    ...
                                                                    <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                                                                        <label class="visually-hidden" for="specificSizeInputExpairyDate2">ExpairyDate</label>
                                                                        <input type="text" class="form-control" id="specificSizeInputExpairyDate2" placeholder="Expairy Date">
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li>
                                ...
                                <div class="col-12 border-bottom">
                                    ...
                                    <div class="theme-box-shadow theme-border-radius bg-light mb-3">
                                        <div class="row border-bottom py-2 m-auto">
                                            ...
                                            <div class="col-4 text-end align-self-center">
                                                <a class="font-small" data-bs-toggle="collapse" href="#collapseChild" role="button" aria-expanded="false" aria-controls="collapseChild"><i
                                                        class="bi bi-chevron-down ps-1"></i></a>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="px-3">
                                                        <ul class="row py-3">
                                                            ...
                                                            <li class="col-12 col-md-4 pb-3">
                                                                <label class="visually-hidden" for="specificSizeInputFirstName2">First Name</label>
                                                                <input type="text" class="form-control" id="specificSizeInputFirstName2" placeholder="First Name">
                                                            </li>
                                                            <li class="col-12 col-md-4 pb-3">
                                                                <label class="visually-hidden" for="specificSizeInputLastName3">Last Name</label>
                                                                <input type="text" class="form-control" id="specificSizeInputLastName3" placeholder="Last Name">
                                                            </li>
                                                            <li class="col-12 col-md-6 pb-3">
                                                                ...
                                                                <div class="row g-0 border">
                                                                    <div class="col">
                                                                        <select class="form-select border-0" id="inlineFormSelectTitle6">
                                                                            <option selected>Date</option>
                                                                            <option value="1">Mr.</option>
                                                                            <option value="2">Mrs.</option>
                                                                            <option value="3">Ms.</option>
                                                                    ...
                                                                    <div class="col">
                                                                        <select class="form-select border-0" id="inlineFormSelectTitle7">
                                                                            <option selected>Month</option>
                                                                            <option value="1">Mr.</option>
                                                                            <option value="2">Mrs.</option>
                                                                            <option value="3">Ms.</option>
                                                                    ...
                                                                    <div class="col">
                                                                        <select class="form-select border-0" id="inlineFormSelectTitle8">
                                                                            <option selected>Year</option>
                                                                            <option value="1">Mr.</option>
                                                                            <option value="2">Mrs.</option>
                                                                            <option value="3">Ms.</option>
                                                            ...
                                                            <li class="col-12 col-md-12 pb-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                                                                        <label class="visually-hidden" for="specificSizeInputPassportNumber3">Passport
                                                                            Number</label>
                                                                        <input type="text" class="form-control" id="specificSizeInputPassportNumber3" placeholder="Passport Number">
                                                                    </div>
                                                                    <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                                                                        <label class="visually-hidden" for="inlineFormSelectNationality">Nationality</label>
                                                                        <select class="form-select" id="inlineFormSelectNationality">
                                                                            <option selected>Nationality</option>
                                                                            <option value="1">Indian</option>
                                                                            <option value="2">German</option>
                                                                            <option value="3">American</option>
                                                                    ...
                                                                    <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                                                                        <label class="visually-hidden" for="inlineFormSelectIssuedCountry2">Issued
                                                                            Country</label>
                                                                        <select class="form-select" id="inlineFormSelectIssuedCountry2">
                                                                            <option selected>Issued Country</option>
                                                                            <option value="1">India</option>
                                                                            <option value="2">German</option>
                                                                            <option value="3">America</option>
                                                                    ...
                                                                    <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                                                                        <label class="visually-hidden" for="specificSizeInputExpairyDate3">ExpairyDate</label>
                                                                        <input type="text" class="form-control" id="specificSizeInputExpairyDate3" placeholder="Expairy Date">
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li>
                                ...
                                <div class="col-12 border-bottom">
                                    ...
                                    <div class="theme-box-shadow theme-border-radius bg-light mb-3">
                                        <div class="row border-bottom py-2 m-auto">
                                            ...
                                            <div class="col-4 text-end align-self-center">
                                                <a class="font-small" data-bs-toggle="collapse" href="#collapseInfant" role="button" aria-expanded="false" aria-controls="collapseInfant"><i
                                                        class="bi bi-chevron-down ps-1"></i></a>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="px-3">
                                                        <ul class="row py-3">
                                                            ...
                                                            <li class="col-12 col-md-4 pb-3">
                                                                <label class="visually-hidden" for="specificSizeInputFirstName3">First Name</label>
                                                                <input type="text" class="form-control" id="specificSizeInputFirstName3" placeholder="First Name">
                                                            </li>
                                                            <li class="col-12 col-md-4 pb-3">
                                                                <label class="visually-hidden" for="specificSizeInputLastName">Last Name</label>
                                                                <input type="text" class="form-control" id="specificSizeInputLastName" placeholder="Last Name">
                                                            </li>
                                                            <li class="col-12 col-md-6 pb-3">
                                                                ...
                                                                <div class="row g-0 border">
                                                                    <div class="col">
                                                                        <select class="form-select border-0" id="inlineFormSelectTitle2">
                                                                            <option selected>Date</option>
                                                                            <option value="1">Mr.</option>
                                                                            <option value="2">Mrs.</option>
                                                                            <option value="3">Ms.</option>
                                                                    ...
                                                                    <div class="col">
                                                                        <select class="form-select border-0" id="inlineFormSelectTitle11">
                                                                            <option selected>Month</option>
                                                                            <option value="1">Mr.</option>
                                                                            <option value="2">Mrs.</option>
                                                                            <option value="3">Ms.</option>
                                                                    ...
                                                                    <div class="col">
                                                                        <select class="form-select border-0" id="inlineFormSelectTitle12">
                                                                            <option selected>Year</option>
                                                                            <option value="1">Mr.</option>
                                                                            <option value="2">Mrs.</option>
                                                                            <option value="3">Ms.</option>
                                                            ...
                                                            <li class="col-12 col-md-12 pb-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                                                                        <label class="visually-hidden" for="specificSizeInputPassportNumber2">Passport
                                                                            Number</label>
                                                                        <input type="text" class="form-control" id="specificSizeInputPassportNumber2" placeholder="Passport Number">
                                                                    </div>
                                                                    <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                                                                        <label class="visually-hidden" for="inlineFormSelectNationality2">Nationality</label>
                                                                        <select class="form-select" id="inlineFormSelectNationality2">
                                                                            <option selected>Nationality</option>
                                                                            <option value="1">Indian</option>
                                                                            <option value="2">German</option>
                                                                            <option value="3">American</option>
                                                                    ...
                                                                    <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                                                                        <label class="visually-hidden" for="inlineFormSelectIssuedCountry3">Issued
                                                                            Country</label>
                                                                        <select class="form-select" id="inlineFormSelectIssuedCountry3">
                                                                            <option selected>Issued Country</option>
                                                                            <option value="1">India</option>
                                                                            <option value="2">German</option>
                                                                            <option value="3">America</option>
                                                                    ...
                                                                    <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                                                                        <label class="visually-hidden" for="specificSizeInputExpairyDate">ExpairyDate</label>
                                                                        <input type="text" class="form-control" id="specificSizeInputExpairyDate" placeholder="Expairy Date">
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li>
                                        ...
                                        <ul class="row pt-3">
                                            ...
                                            <li class="col-12 col-md-4 pb-3">
                                                <label class="font-medium" for="specificSizeInputMobileNo">Mobile
                                                    No</label>
                                                <input type="number" class="form-control" id="specificSizeInputMobileNo" placeholder="Mobile No">
                                            </li>
                                            <li class="col-12 col-md-4 pb-3">
                                                <label class="font-medium" for="specificSizeInputEmail">Email</label>
                                                <input type="text" class="form-control" id="specificSizeInputEmail" placeholder="Email">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <ul class="row pt-3">
                                            <li class="col-12 col-md-4 pb-3">
                                                <label class="font-medium" for="specificSizeInputGSTINNumber">GSTIN
                                                    Number</label>
                                                <input type="number" class="form-control" id="specificSizeInputGSTINNumber" placeholder="Enter GSTIN Number">
                                            </li>
                                            <li class="col-12 col-md-4 pb-3">
                                                <label class="font-medium" for="specificSizeInputCompanyName">Company
                                                    Name*</label>
                                                <input type="text" class="form-control" id="specificSizeInputCompanyName" placeholder="Enter Name">
                                            </li>
                                            <li class="col-12 col-md-4 pb-3">
                                                <label class="font-medium" for="specificSizeInputCompanyEmail">Company
                                                    Email*</label>
                                                <input type="text" class="form-control" id="specificSizeInputCompanyEmail" placeholder="Enter Company Email">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <ul class="d-flex flex-row">
                                            ...
                                            <li class="theme-box-shadow theme-border-radius p-3 border">
                                                <a href="traveller-addons-seat.jsp"><img
                                ...
                                <div class="col-12 mb-3">
                                    <div class="theme-box-shadow theme-border-radius bg-light">
                                        <ul class="">
                                            ...
                                            <!-- airline charge fare -->
                                            <li class="border-bottom p-3 font-medium">
                                                <a class="d-flex justify-content-between theme-text-accent-one" data-bs-toggle="collapse" href="#airlineSurcharge" role="button" aria-expanded="false" aria-controls="airlineSurcharge">
                                                    <span class="font-medium fw-bold">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="theme-box-shadow theme-border-radius bg-light p-3 font-small">
                                        Cancellation &amp; Date change charges <a href="#" class="">More</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="theme-box-shadow theme-border-radius bg-light mb-3 p-3">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <button type="submit" class="btn btn-effect btn-book px-5" onclick="window.location.href='traveller-addons-meal.html';">Continue</button>
                                    </div>
                                </div>
                            </div>
                        </div>
