...
<html lang="en">
    ...
    <head>
        ...
        <!--title tag for page -->
        <title>Flight World - Change Password Page</title>
    </head>
                            ...
                            <div class="theme-box-shadow theme-border-radius theme-bg-white p-3">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="font-medium mb-0 theme-text-accent-one">Forgot password and Get lots of Cashback Rewards and Discount
                                        </p>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <form class="needs-validation" novalidate action="/change-password" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control min-h58" id="exampleInputPassword1" name="currentPassword" placeholder="Enter Your Current Password" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleInputPassword2" class="form-label">New Password</label>
                                            <input type="password" class="form-control min-h58" id="exampleInputPassword2" name="newPassword" placeholder="Enter Your New Password" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleInputPassword3" class="form-label">Confirm New Password</label>
                                            <input type="password" class="form-control min-h58" id="exampleInputPassword3" name="confirmPassword" placeholder="Confirm Your New Password" required>
                                        </div>
                                        <div class="mb-3 form-check">
                                            <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                            <label class="form-check-label font-small" for="exampleCheck1">Remember Me</label>
                                        </div>
                                        <h2 style="text-align:center; color:red;">${errorMsg}</h2>
                                        <div class="mb-3">
                                            <button type="submit" class="btn btn-effect btn-book px-5 min-h58" onclick="window.location.href='#';">Submit</button>
                                            <a href="signin.jsp" class="">Back to Login</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
