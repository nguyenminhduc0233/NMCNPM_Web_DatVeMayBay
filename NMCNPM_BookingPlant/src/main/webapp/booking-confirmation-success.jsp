...
<head>
    ...
    <!--title tag for page -->
    <title>FlightWorld - Booking Confirmation - Success</title>
</head>
                            ...
                            <div class="col-12 col-md-8">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="p-2 border border-success rounded-circle lh-1"><i class="bi bi-check-lg fs-2 text-success"></i></div>
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <span class="fs-4 fw-bold">Your Booking is Confirmed!</span>
                                        <p class="mb-0 font-medium">Thank you for booking with Flight World. You will soon receive a confirmation via email.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4 text-end">
                                <div class="font-medium fw-bold border p-2 d-inline-block theme-border-radius">Booking ID: <a href="#" class="text-success">#115477</a>
                                </div>
                                <div class="font-medium mt-3"><span class="fw-bold">Booked on:</span> 9/02/2020 | 12:27:12 PM</div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
