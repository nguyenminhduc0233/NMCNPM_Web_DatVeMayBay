...
<%@ page import="vn.edu.hcmuaf.fit.models.User" %>
                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                <td class="px-4 py-3">
                                    <div class="flex items-center text-sm">
                                        ...
                                        <div>
                                            <p class="font-semibold"><%=c.getUsername()%></p>
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <%
                                        ...
                                        int id = c.getId();
                                        List<String> list_permission = UserService.getListRolesExcept(id);
...
<script>
    ...
    {
        let value = obj.value;
        window.location = "/change_role?name=" + value+"&id="+id;
