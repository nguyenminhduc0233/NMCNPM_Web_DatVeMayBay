...
<head>
    ...
    <!--title tag for page -->
    <title>FlightWorld - Traveller Addons - Meals Details</title>
</head>
                                        ...
                                        <div class="row g-0 mb-3">
                                            ...
                                            <div class="col-12 p-3">
                                                ...
                                                <ul class="d-md-flex justify-content-between pt-3">
                                                    <li class="pb-3">
                                                        <img src="assets/images/icons/veg-meal.png" class="img-fluid" alt="Meal">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-end">
                                                            ...
                                                            <div class="add-btn-wrap">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="quant[1]" class="form-control input-number text-center border-0" value="Add">
                                                                    <span class="input-group-btn">
                                                                        <button type="button"
                                                                            class="btn btn-default btn-number"
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-end">
                                                            ...
                                                            <div class="add-btn-wrap">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="quant[2]" class="form-control input-number text-center border-0" value="Add">
                                                                    <span class="input-group-btn">
                                                                        <button type="button"
                                                                            class="btn btn-default btn-number"
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-end">
                                                            ...
                                                            <div class="add-btn-wrap">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="quant[3]" class="form-control input-number text-center border-0" value="Add">
                                                                    <span class="input-group-btn">
                                                                        <button type="button"
                                                                            class="btn btn-default btn-number"
                                                ...
                                                <ul class="d-md-flex justify-content-between pt-3">
                                                    <li class="pb-3">
                                                        <img src="assets/images/icons/nonveg-meal.png" class="img-fluid" alt="Meal">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-end">
                                                            ...
                                                            <div class="add-btn-wrap">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="quant[4]" class="form-control input-number text-center border-0" value="Add">
                                                                    <span class="input-group-btn">
                                                                        <button type="button"
                                                                            class="btn btn-default btn-number"
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-end">
                                                            ...
                                                            <div class="add-btn-wrap">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="quant[5]" class="form-control input-number text-center border-0" value="Add">
                                                                    <span class="input-group-btn">
                                                                        <button type="button"
                                                                            class="btn btn-default btn-number"
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-end">
                                                            ...
                                                            <div class="add-btn-wrap">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="quant[6]" class="form-control input-number text-center border-0" value="Add">
                                                                    <span class="input-group-btn">
                                                                        <button type="button"
                                                                            class="btn btn-default btn-number"
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-end">
                                                            ...
                                                            <div class="add-btn-wrap">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="quant[7]" class="form-control input-number text-center border-0" value="Add">
                                                                    <span class="input-group-btn">
                                                                        <button type="button"
                                                                            class="btn btn-default btn-number"
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-end">
                                                            ...
                                                            <div class="add-btn-wrap">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="quant[8]" class="form-control input-number text-center border-0" value="Add">
                                                                    <span class="input-group-btn">
                                                                        <button type="button"
                                                                            class="btn btn-default btn-number"
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-end">
                                                            ...
                                                            <div class="add-btn-wrap">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="quant[9]" class="form-control input-number text-center border-0" value="Add">
                                                                    <span class="input-group-btn">
                                                                        <button type="button"
                                                                            class="btn btn-default btn-number"
                                                ...
                                                <ul class="d-md-flex justify-content-between pt-3">
                                                    <li class="pb-3">
                                                        <img src="assets/images/icons/beverages.png" class="img-fluid" alt="Meal">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-end">
                                                            ...
                                                            <div class="add-btn-wrap">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="quant[10]" class="form-control input-number text-center border-0" value="Add">
                                                                    <span class="input-group-btn">
                                                                        <button type="button"
                                                                            class="btn btn-default btn-number"
