...
<head>
    ...
    <!--title tag for page -->
    <title>Flight World - Blog Page</title>
</head>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <span class="fw-bold theme-text-white">Blog - Unique Experiences</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row" data-aos="fade-up" data-aos-delay="200">
                        <div class="col-12 col-md-4 mb-4">
                            <div class="position-relative theme-border-radius theme-box-shadow item-effect mh-100">
                                ...
                                <img src="assets/images/unique-ex/articles01.png" class="img-fluid" alt="Unique Experience One" title="Unique Experience One">
                        ...
                        <div class="col-12 col-md-4 mb-4">
                            <div class="position-relative theme-border-radius theme-box-shadow item-effect mh-100">
                                ...
                                <img src="assets/images/unique-ex/articles02.png" class="img-fluid" alt="Unique Experience Two" title="Unique Experience Two">
                                <a href="#" class="text-center"><i class="bi bi-search"></i></a>
                            </div>
                        </div>
                        <div class="col-12 col-md-4 mb-4">
                            <div class="position-relative theme-border-radius theme-box-shadow item-effect mh-100">
                                ...
                                <img src="assets/images/unique-ex/articles03.png" class="img-fluid" alt="Unique Experience Three" title="Unique Experience Three">
                                <a href="#" class="text-center"><i class="bi bi-search"></i></a>
                            </div>
                        </div>
                        <div class="col-12 col-md-4 mb-4">
                        ...
                        <div class="col-12 col-md-4 mb-4">
                            <div class="position-relative theme-border-radius theme-box-shadow item-effect mh-100">
                                ...
                                <img src="assets/images/unique-ex/articles05.png" class="img-fluid" alt="Unique Experience Five" title="Unique Experience Five">
                                <a href="#" class="text-center"><i class="bi bi-search"></i></a>
                            </div>
                        </div>
                        <div class="col-12 col-md-4 mb-4">
                        ...
                        <div class="col-12 col-md-4 mb-4">
                            <div class="position-relative theme-border-radius theme-box-shadow item-effect mh-100">
                                <div class="con theme-text-white theme-text-shadow">
                                    <h2 class="h6 fw-bold d-inline-flex border-bottom pb-2">Machu Picchu, Peru</h2>
                                    <span class="d-flex font-14">Get prices</span>
                                </div>
                                <img src="assets/images/unique-ex/articles07.png" class="img-fluid" alt="Unique Experience Six" title="Unique Experience Six">
                                <a href="#" class="text-center"><i class="bi bi-search"></i></a>
                            </div>
                        </div>
                        <!-- repetable -->
                        <div class="col-12 col-md-4 mb-4">
                            <div class="position-relative theme-border-radius theme-box-shadow item-effect mh-100">
                                <div class="con theme-text-white theme-text-shadow">
                                    <h2 class="h6 fw-bold d-inline-flex border-bottom pb-2">Safari, Africa</h2>
                                    <span class="d-flex font-14">Get prices</span>
                                </div>
                                <img src="assets/images/unique-ex/articles08.png" class="img-fluid" alt="Unique Experience Six" title="Unique Experience Six">
                                <a href="#" class="text-center"><i class="bi bi-search"></i></a>
                            </div>
                        </div>
                        <!-- repetable -->
                        <div class="col-12 col-md-4 mb-4">
                            <div class="position-relative theme-border-radius theme-box-shadow item-effect mh-100">
                                ...
                                <img src="assets/images/unique-ex/articles09.png" class="img-fluid" alt="Unique Experience Six" title="Unique Experience Six">
                                <a href="#" class="text-center"><i class="bi bi-search"></i></a>
                            </div>
                        </div>
                        <!-- repetable -->
                        <div class="col-12 col-md-4 mb-4">
                            <div class="position-relative theme-border-radius theme-box-shadow item-effect mh-100">
                                <div class="con theme-text-white theme-text-shadow">
                                    <h2 class="h6 fw-bold d-inline-flex border-bottom pb-2">Rainforest, Brazil</h2>
                                    <span class="d-flex font-14">Get prices</span>
                                </div>
                                <img src="assets/images/unique-ex/articles10.png" class="img-fluid" alt="Unique Experience Six" title="Unique Experience Six">
                                <a href="#" class="text-center"><i class="bi bi-search"></i></a>
                            </div>
                        </div>
                        <!-- repetable -->
                        <div class="col-12 col-md-4 mb-4">
                            <div class="position-relative theme-border-radius theme-box-shadow item-effect mh-100">
                                <div class="con theme-text-white theme-text-shadow">
                                    <h2 class="h6 fw-bold d-inline-flex border-bottom pb-2">Santorini, Greece</h2>
                                    <span class="d-flex font-14">Get prices</span>
                                </div>
                                <img src="assets/images/unique-ex/articles11.png" class="img-fluid" alt="Unique Experience Six" title="Unique Experience Six">
                                <a href="#" class="text-center"><i class="bi bi-search"></i></a>
                            </div>
                        </div>
                        <!-- repetable -->
                        <div class="col-12 col-md-4 mb-4">
                            <div class="position-relative theme-border-radius theme-box-shadow item-effect mh-100">
                                <div class="con theme-text-white theme-text-shadow">
                                    <h2 class="h6 fw-bold d-inline-flex border-bottom pb-2">Bali, Indonesia</h2>
                                    <span class="d-flex font-14">Get prices</span>
                                </div>
                                <img src="assets/images/unique-ex/articles12.png" class="img-fluid" alt="Unique Experience Six" title="Unique Experience">
                                <a href="#" class="text-center"><i class="bi bi-search"></i></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-center">
                                    <li class="page-item disabled">
                                        <a class="page-link" href="blog.jsp" tabindex="-1"><i
