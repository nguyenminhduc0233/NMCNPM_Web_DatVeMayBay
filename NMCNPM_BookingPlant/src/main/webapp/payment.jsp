...
<head>
    ...
    <!--title tag for page -->
    <title>FlightWorld - Payment Page</title>
</head>
...
<body>
                        ...
                        <div class="col-12 col-md-8">
                                ...
                                <div class="row border-bottom py-3 m-auto">
                                    <div class="col-12 col-md-6">
                                        <div class="fw-bold font-medium">
                                            <img src="assets/images/icons/wallet-app.png" class="img-fluid" alt="wallet">
                            ...
                            <div class="row g-0 py-3">
                                <div class="col-12 col-md-6">
                                    ...
                                    <p class="mb-0 mt-2 font-small theme-text-accent-one">* Your Payments are secured by SSL certificate
                                    </p>
                                </div>
                                <div class="col-12 col-md-6">
                                    <img src="assets/images/payment-icon.png" alt="payment-option-icons" class="img-fluid">
                                </div>
                            </div>
                            <!-- payment method body -->
                            <div class="theme-box-shadow theme-border-radius theme-bg-white mb-3">
                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-12 col-sm-4 col-md-2 col-lg-2 col-xl-2 col-xxl-3">
                                                <div class="nav flex-column nav-pills me-1 custom-tab" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                    <button class="nav-link first-tab active" id="v-pills-credit-tab" data-bs-toggle="pill" data-bs-target="#v-pills-credit" type="button" role="tab" aria-controls="v-pills-credit" aria-selected="true"><i class="payment-icon credit"></i>Credit
                                                        Card</button>

                                                    <button class="nav-link" id="v-pills-debit-tab" data-bs-toggle="pill" data-bs-target="#v-pills-debit" type="button" role="tab" aria-controls="v-pills-debit" aria-selected="false"><i class="payment-icon debit"></i>Debit
                                                        Card</button>
                                                    ...
                                                    <button class="nav-link" id="v-pills-upi-tab" data-bs-toggle="pill" data-bs-target="#v-pills-upi" type="button" role="tab" aria-controls="v-pills-upi" aria-selected="false"><i
                                                            class="payment-icon upi"></i>UPI</button>

                                                    <button class="nav-link" id="v-pills-apppay-tab" data-bs-toggle="pill" data-bs-target="#v-pills-apppay" type="button" role="tab" aria-controls="v-pills-apppay" aria-selected="false"><i
                                                            class="payment-icon phone"></i>PhonePay/ Paytm</button>

                                                    <button class="nav-link" id="v-pills-wallet-tab" data-bs-toggle="pill" data-bs-target="#v-pills-wallet" type="button" role="tab" aria-controls="v-pills-wallet" aria-selected="false"><i class="payment-icon wallet"></i>Mobile
                                                        Wallet</button>

                                                    <button class="nav-link" id="v-pills-payPal-tab" data-bs-toggle="pill" data-bs-target="#v-pills-payPal" type="button" role="tab" aria-controls="v-pills-payPal" aria-selected="false"><i
                                                            class="payment-icon paypal"></i>Paypal</button>

                                                    <button class="nav-link last-tab" id="v-pills-emi-tab" data-bs-toggle="pill" data-bs-target="#v-pills-emi" type="button" role="tab" aria-controls="v-pills-emi" aria-selected="false"><i class="payment-icon emi"></i>No
                                                        Cost
                                                        EMI</button>
                                                </div>
                                            </div>
                                                ...
                                                <div class="tab-content p-4" id="v-pills-tabContent">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 mb-3">
                                                                <span class="d-flex fw-bold mb-3">Pay with Credit
                                                                    Card</span>
                                                                <img src="assets/images/card-options-icon.png" alt="card-options-icon" class="img-fluid">
                                                            </div>
                                                            <div class="col-12 col-xl-10">
                                                                <div class="mb-3">
                                                                    <label for="exampleInputNumber" class="form-label">Card
                                                                        Number</label>
                                                                    <input type="email" class="form-control" id="exampleInputNumber" placeholder="Enter card number here">
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="exampleInputCardName" class="form-label">Name on Card</label>
                                                                    <input type="email" class="form-control" id="exampleInputCardName" placeholder="Enter name here">
                                                                </div>
                                                                <div class="mb-3">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-12 col-lg-6 mt-3 mt-lg-0">
                                                                            ...
                                                                            <div class="d-flex align-items-center">
                                                                                <input type="email" class="form-control" id="exampleInputCVV" placeholder="CVV">
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="form-check">
                                                                        ...
                                                                        <label class="form-check-label font-small theme-text-accent-one" for="flexCheckChecked1">
                                                    ...
                                                    <div class="tab-pane fade" id="v-pills-debit" role="tabpanel" aria-labelledby="v-pills-debit-tab">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-xl-10">
                                                                <div class="mb-3">
                                                                    <label for="exampleInputCardNumber" class="form-label">Card
                                                                        Number</label>
                                                                    <input type="email" class="form-control" id="exampleInputCardNumber" placeholder="Enter card number here">
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="exampleInputName" class="form-label">Name on Card</label>
                                                                    <input type="email" class="form-control" id="exampleInputName" placeholder="Enter name here">
                                                                </div>
                                                                <div class="mb-3">
                                                                    <div class="row">
                                                                        <div class="col-12 col-lg-6">
                                                                        ...
                                                                        <div class="col-12 col-lg-6 mt-3 mt-lg-0">
                                                                            <label for="exampleInputCreditCVV" class="form-label">CVV Code</label>
                                                                            <div class="d-flex align-items-center">
                                                                                <input type="email" class="form-control" id="exampleInputCreditCVV" placeholder="CVV">
                                                                                <span class="font-extra-small ms-1">3
                                                                                    digits
                                                                                    printed on the
                                                                                    back of the card</span>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <button type="submit" class="btn btn-effect btn-book px-5" onclick="window.location.href='booking-confirmation-success.html';">
                                        <span class="fw-bold">Pay Now</span>
                                    </button>
                                    <p class="mt-2 mb-0 theme-text-accent-one font-small">On Clicking "Pay" you will be redirected to the payment gateway</p>
                                </div>
                                            ...
                                            <div class="col-12 pb-3 mb-3 border-bottom">
                                                <div class="row">
                                                    <div class="col-12 col-md-12 mb-2">
                                                        <div class="d-flex">
                                                            <div>
                                                                <img src="assets/images/icons/D-indigo.jpg" alt="airline-indigo" title="airline-indigo">
                                                            </div>
                                            ...
                                            <div class="col-12 pb-3 mb-3 border-bottom">
                                                <div class="row">
                                                    <div class="col-12 col-md-12 mb-2">
                                                        <div class="d-flex">
                                                            <div>
                                                                <img src="assets/images/icons/D-goair.jpg" alt="airline-goair" title="airline-goair">
                                                            </div>
                                                            <div class="d-flex flex-column ms-2">
                                                                <span class="font-medium fw-bold mb-0">Return Mon, 01
                                                                    Apr
                                                                </span>
                                                                <span class="font-medium mb-0 theme-text-accent-one">Kochi
    ...
    <!-- session timer -->
    <script src="assets/js/session-timer.js"></script>
